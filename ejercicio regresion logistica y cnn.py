# -*- coding: utf-8 -*-
"""
Created on Wed Aug 25 14:01:25 2021
...
#utilicemos keras.  sin nodos o capas escondidas.
model = Sequential()
...
#grafico limite, no funciona

plot_multiclass_decision_boundary(model, X, y_cat)

#metricas
y_pred = (model.predict(X) > 0.5).astype("int32")
print(classification_report(y_cat, y_pred))
plot_confusion_matrix(model, X, y_cat)
